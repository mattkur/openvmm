...
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, IntoBytes, Immutable, FromBytes)]
...
#[derive(Copy, Clone, Debug, PartialEq, Eq, IntoBytes, Immutable, FromBytes, Protobuf, Inspect)]
#[repr(C, align(4))]
#[mesh(transparent)]
#[inspect(transparent)]
...
#[repr(C)]
#[derive(Copy, Clone, Debug, Inspect, PartialEq, Eq, IntoBytes, Immutable, FromBytes)]
...
#[bitfield(u16)]
#[derive(IntoBytes, Immutable, FromBytes, PartialEq, Eq, Protobuf)]
#[mesh(transparent)]
...
#[repr(C)]
#[derive(Copy, Clone, Eq, PartialEq, Debug, IntoBytes, Immutable, FromBytes)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone, Eq, PartialEq, IntoBytes, Immutable, FromBytes)]
...
#[repr(C)]
#[derive(PartialEq, Eq, Debug, Copy, Clone, IntoBytes, Immutable, FromBytes)]
