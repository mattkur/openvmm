...
#[repr(C)]
#[derive(Copy, Clone, Debug, IntoBytes, Immutable, FromBytes, Inspect)]
pub struct Command {
    pub cdw0: Cdw0,
    pub nsid: u32,
    pub cdw2: u32,
...
#[repr(C)]
#[derive(Debug, IntoBytes, Immutable, FromBytes, Inspect, Clone)]
...
open_enum! {
    #[derive(IntoBytes, Immutable, FromBytes, Inspect)]
    #[inspect(debug)]
