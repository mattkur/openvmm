...
impl<'a> TestNicChannel<'a> {
    ...
    where
        T: zerocopy::KnownLayout + zerocopy::IntoBytes, Immutable,
    {
    ...
    pub async fn send_rndis_control_message_no_completion<T: IntoBytes>(
        &mut self,
        message_type: u32,
        message: T,
        extra: &[u8],
    ...
    pub async fn send_rndis_control_message<T: IntoBytes>(
        &mut self,
        message_type: u32,
        message: T,
        extra: &[u8],
